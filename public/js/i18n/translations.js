export const translations = {
  pt: {
    ...
    mistakes_center_title: "Central de Erros",
    mistakes_center_subtitle:
      "Revise as questoes que mais precisam da sua atencao.",
    mistakes_pending: "Pendentes",
    mistakes_resolved: "Resolvidos",
    mistakes_recurrent: "Recorrentes",
    mistakes_critical_domain: "Dominio critico",
    mistakes_all: "Todos",
    mistakes_status: "Status",
    mistakes_domain: "Dominio",
    mistakes_certification: "Certificacao",
    mistakes_list_title: "Questoes para revisar",
    mistakes_practice_pending: "Praticar erros pendentes",
    mistakes_empty_pending:
      "Nenhum erro pendente. Continue praticando para identificar pontos de revisao.",
    mistakes_empty_filter: "Nenhum erro encontrado com estes filtros.",
    mistakes_clear_filters: "Limpar filtros",
    mistakes_pending_empty_title: "Nenhum erro pendente",
    mistakes_count: "Errou {{count}} vez(es)",
    mistakes_view_details: "Ver detalhes",
    mistakes_your_answer: "Sua resposta",
    mistakes_correct_answer: "Resposta correta",
    mistakes_status_pending: "Pendente",
    mistakes_status_resolved: "Resolvido",
    review_deck_total: "Total",
    review_deck_pending: "Pendentes",
    review_deck_mastered: "Dominados",
    review_deck_all: "Todos",
    review_deck_status: "Status",
    review_deck_empty: "Seu Deck de Revisão está vazio.",
    review_deck_empty_pending: "Você revisou todos os cards pendentes.",
    review_deck_empty_pending_desc:
      "Escolha 'Dominados' para consultar seus cards ou adicione novas questões durante um simulado.",
    review_deck_still_pending: "Ainda preciso revisar",
    review_deck_mastered_action: "Já domino",
    review_deck_review_again: "Revisar novamente",
    ...
    auth_continue_local: "Continuar estudando sem conta",
  ...
  en: {
    ...
    mistakes_center_title: "Mistakes Center",
    mistakes_center_subtitle:
      "Review the questions that need your attention most.",
    mistakes_pending: "Pending",
    mistakes_resolved: "Resolved",
    mistakes_recurrent: "Recurring",
    mistakes_critical_domain: "Critical domain",
    mistakes_all: "All",
    mistakes_status: "Status",
    mistakes_domain: "Domain",
    mistakes_certification: "Certification",
    mistakes_list_title: "Questions to review",
    mistakes_practice_pending: "Practice pending mistakes",
    mistakes_empty_pending:
      "No pending mistakes. Keep practicing to identify review points.",
    mistakes_empty_filter: "No mistakes found with these filters.",
    mistakes_clear_filters: "Clear filters",
    mistakes_pending_empty_title: "No pending mistakes",
    mistakes_count: "Missed {{count}} time(s)",
    mistakes_view_details: "View details",
    mistakes_your_answer: "Your answer",
    mistakes_correct_answer: "Correct answer",
    mistakes_status_pending: "Pending",
    mistakes_status_resolved: "Resolved",
    review_deck_total: "Total",
    review_deck_pending: "Pending",
    review_deck_mastered: "Mastered",
    review_deck_all: "All",
    review_deck_status: "Status",
    review_deck_empty: "Your Review Deck is empty.",
    review_deck_empty_pending: "You reviewed all pending cards.",
    review_deck_empty_pending_desc:
      "Choose 'Mastered' to view your cards or add new questions during a simulation.",
    review_deck_still_pending: "I still need to review",
    review_deck_mastered_action: "I mastered it",
    review_deck_review_again: "Review again",
    ...
    auth_continue_local: "Continue studying without an account",
    auth_local_first_description:
