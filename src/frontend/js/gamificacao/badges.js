...
const BADGE_CATALOG = [
  ...
  // ==========================================
  {
    ...
    desc: {
      pt: "Gabaritou um simulado inteiro.",
      en: "Aced an entire exam simulation.",
    },
  },
  {
    id: "dedicated",
    ...
    desc: {
      pt: "Completou 10 simulados oficiais.",
      en: "Completed 10 official quizzes.",
    },
  },
  {
    id: "streak",
    ...
    desc: {
      pt: "Aprovada 5 vezes consecutivas.",
      en: "Passed 5 times in a row.",
    },
  },
  {
    id: "speed",
    ...
    desc: {
      pt: "Terminou um simulado na metade do tempo.",
      en: "Finished a quiz in half the time.",
    },
  },
  ...
  // ==========================================
  {
    ...
    desc: {
      pt: "Dominou os conceitos globais.",
      en: "Mastered global concepts.",
    },
  },
  {
    id: "clf-2",
    ...
    desc: {
      pt: "Dominou Segurança e Compliance.",
      en: "Mastered Security & Compliance.",
    },
  },
  {
    id: "clf-3",
    ...
    desc: {
      pt: "Dominou os serviços principais.",
      en: "Mastered core services.",
    },
  },
  {
    id: "clf-final",
    ...
    desc: {
      pt: "Pronta para a prova oficial.",
      en: "Ready for the official exam.",
    },
  },
  ...
  // ==========================================
  {
    ...
    desc: {
      pt: "Desenhou arquiteturas seguras.",
      en: "Designed secure architectures.",
    },
  },
  {
    id: "saa-2",
    ...
    desc: {
      pt: "Criou sistemas resilientes.",
      en: "Created resilient systems.",
    },
  },
  {
    id: "saa-3",
    ...
    desc: {
      pt: "Arquitetou redes escaláveis.",
      en: "Architected scalable networks.",
    },
  },
  {
    id: "saa-4",
  ...
  // ==========================================
  {
    ...
    desc: {
      pt: "Dominou desenvolvimento na AWS.",
      en: "Mastered AWS development.",
    },
  },
  {
    id: "dva-2",
    ...
    desc: {
      pt: "Especialista em deploy automatizado.",
      en: "Automated deployment expert.",
    },
  },
  {
    id: "dva-3",
    ...
    bg: "bg-violet-500/10", // Ícone cortado para serverless
    title: { pt: "Especialista Serverless", en: "Serverless Pro" },
    desc: {
      pt: "Dominou Lambda e API Gateway.",
      en: "Mastered Lambda & API Gateway.",
    },
  },
  {
    id: "dva-final",
    ...
    desc: {
      pt: "Pronta para criar na nuvem.",
      en: "Ready to build in the cloud.",
    },
  },
  ...
  },
  {
    ...
    desc: {
      pt: "Treinou e fez deploy de modelos.",
      en: "Trained and deployed models.",
    },
  },
  {
    id: "aif-final",
    ...
    desc: {
      pt: "Certificada em Inteligência Artificial.",
      en: "Certified in Artificial Intelligence.",
    },
  },
];
...
export function renderBadges() {
  ...
  container.innerHTML = badgesToShow
    .map((badge) => {
      const isEarned =
        badge.type === "stage"
      ...
      const glassClass = isEarned
        ? "badge-glass"
        : "badge-glass opacity-40 grayscale cursor-not-allowed";
      ...
      return `
            <div class="a3-card relative ${glassClass} ${isEarned ? badge.bg : "bg-gray-100/10"} p-4 flex flex-col items-center text-center transition-all duration-300">
                ...
                <p class="text-[9px] text-muted mt-1">${badge.desc[currentLang]}</p>
            </div>
        `;
    })
    .join("");
